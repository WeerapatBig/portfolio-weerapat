...
const projects = [
  {
    ...
    summary: "การ์ดเชิญงานแต่งงานออนไลน์ อบอุ่นเป็นส่วนตัว เปิดบนมือถือลื่น พร้อมระบบ RSVP",
  ...
  },
  {
    ...
    summary: "เว็บ Portfolio ส่วนตัว สะอาด มืออาชีพ และอัปเดตผลงานเองได้",
  ...
  },
  {
    ...
    summary: "Landing Page ร้านขายต้นไม้ ดูน่าเชื่อถือ ดันลูกค้าสู่ LINE ในหน้าเดียว",
  ...
  },
  {
    ...
    summary: "Landing Page กระเป๋าสตางค์พรีเมียม ภาพหรู ดูน่าซื้อตั้งแต่แรกเห็น",
...
const siteConfig = {
  ...
  services: [
    {
      ...
      desc: "ออกแบบเว็บที่สวย ใช้งานง่าย และตรงกับตัวตนของแบรนด์คุณ",
    },
    {
      title: "Mobile Content",
      fit: "ธุรกิจที่ต้องการส่ง SMS, LINE, IVR เชื่อมต่อกับลูกค้าไม่ให้พลาดข่าวสาร",
      desc: "บริการ SMS, IVR, USSD และ LINE เชื่อมระบบลูกค้าเข้ากับระบบข้อความ รองรับทุกเครือข่าย",
    },
    {
      title: "Application Develop",
      fit: "ธุรกิจที่ต้องการแอปมือถือหรือเว็บแอปครบครัน ตอบโจทย์การใช้งาน",
      desc: "พัฒนาแอปมือถือและเว็บแอปที่ครบครันและมีประสิทธิภาพ ตอบโจทย์ทุกการใช้งาน",
    },
    {
      title: "Customise on Request",
      fit: "ทุกธุรกิจที่มีความต้องการเฉพาะ ต้องการระบบหรือฟีเจอร์ปรับแต่ง",
      desc: "ปรับแต่งเว็บและแอปตามความต้องการเฉพาะของแต่ละธุรกิจ ให้ได้สิ่งที่ต้องการจริง ๆ",
    },
  ],
  ...
  faq: [
    {
      q: "ใช้เวลาพัฒนาเว็บกี่วัน?",
      a: "ระยะเวลาขึ้นกับขอบเขตงานครับ โปรเจกต์เล็กอาจใช้ไม่กี่สัปดาห์ โปรเจกต์ใหญ่หรือมีฟีเจอร์เยอะอาจใช้ 1–3 เดือน หลังแจ้งความต้องการมา เราจะประเมินและบอกช่วงเวลาโดยประมาณให้ครับ",
    },
    {
      q: "ราคาเริ่มต้นประมาณเท่าไหร่?",
      a: "ราคาขึ้นกับประเภทเว็บและฟีเจอร์ที่ต้องการครับ มีทั้งเว็บนำเสนอผลงาน เว็บร้านค้า และเว็บแอปพลิเคชัน แนะนำบอกงบเป็นช่วงหรือความต้องการมาได้ เราจะเลือกผลงานที่ใกล้เคียงให้ดูและประเมินราคาให้ครับ",
    },
    {
      q: "รับทำเว็บอสังหาริมทรัพย์ไหม?",
      a: "รับครับ เรามีผลงานเว็บอสังหาและฝากขายหลายโปรเจกต์ เช่น ระบบค้นหาบ้าน-คอนโด แสดงรายการ และหน้าติดต่อ ลองดูโปรเจกต์ในหมวดอสังหาริมทรัพย์ได้ครับ",
    },
    {
      q: "มีบริการหลังส่งมอบไหม?",
      a: "มีครับ หลังส่งมอบเราพร้อมให้คำปรึกษาและดูแลตามที่ตกลงกัน เช่น แก้ไขข้อความ ปรับรูปแบบเล็กน้อย หรือให้คำแนะนำการใช้งาน ถ้ามีความต้องการเฉพาะสามารถคุยรายละเอียดตอนประเมินงานได้ครับ",
    },
  ],
};
